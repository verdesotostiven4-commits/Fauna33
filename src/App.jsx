...
const orders = [
  {
    ...
    families: [
      { name:'Aromobatidae', common:'ranas nodrizas', traits:['Antiguamente conformaban la familia Dendrobatidae.'], species:[sp('Allobates trilineatus','rana nodriza rayada'), sp('Allobates zaparo','rana nodriza zaparo')] },
      ...
      { name:'Craugastoridae', common:'ranas cutín', traits:['Ranas cutín incluidas en el orden Anura.'], species:[sp('Barycholos pulcher','cutín de Chimbo'),sp('Craugastor longirostris','cutín de hocico largo')] },
